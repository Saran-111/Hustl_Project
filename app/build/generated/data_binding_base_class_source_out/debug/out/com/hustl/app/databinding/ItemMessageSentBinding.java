...
public final class ItemMessageSentBinding implements ViewBinding {
  ...
  private ItemMessageSentBinding(@NonNull LinearLayout rootView, @NonNull TextView tvMessage,
  ...
  public static ItemMessageSentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMessageSentBinding((LinearLayout) rootView, tvMessage, tvTime);
    }

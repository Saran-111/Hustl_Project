...
public final class FragmentOrdersBinding implements ViewBinding {
  ...
  private FragmentOrdersBinding(@NonNull FrameLayout rootView, @NonNull ProgressBar progressBar,
      @NonNull RecyclerView rvOrders, @NonNull TextView tvEmpty) {
  ...
  public static FragmentOrdersBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentOrdersBinding((FrameLayout) rootView, progressBar, rvOrders, tvEmpty);
    }

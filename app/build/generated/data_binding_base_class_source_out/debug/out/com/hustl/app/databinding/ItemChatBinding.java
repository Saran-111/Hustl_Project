...
public final class ItemChatBinding implements ViewBinding {
  ...
  private ItemChatBinding(@NonNull CardView rootView, @NonNull TextView tvGigTitle,
      @NonNull TextView tvLastMessage, @NonNull TextView tvTime) {
  ...
  public static ItemChatBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemChatBinding((CardView) rootView, tvGigTitle, tvLastMessage, tvTime);
    }

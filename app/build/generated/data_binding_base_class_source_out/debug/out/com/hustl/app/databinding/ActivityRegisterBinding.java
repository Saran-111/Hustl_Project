...
public final class ActivityRegisterBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialButton btnBuyer;

  @NonNull
  public final MaterialButton btnRegister;

  @NonNull
  public final MaterialButton btnSeller;
  ...
  private ActivityRegisterBinding(@NonNull ScrollView rootView, @NonNull MaterialButton btnBuyer,
      @NonNull MaterialButton btnRegister, @NonNull MaterialButton btnSeller,
  ...
  public static ActivityRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.btnBuyer;
      MaterialButton btnBuyer = ViewBindings.findChildViewById(rootView, id);
      if (btnBuyer == null) {
        break missingId;
      }
      ...
      id = R.id.btnSeller;
      MaterialButton btnSeller = ViewBindings.findChildViewById(rootView, id);
      if (btnSeller == null) {
        break missingId;
      }
      ...
      return new ActivityRegisterBinding((ScrollView) rootView, btnBuyer, btnRegister, btnSeller,
          etConfirmPassword, etEmail, etName, etPassword, ivBack, progressBar, tilConfirmPassword,
